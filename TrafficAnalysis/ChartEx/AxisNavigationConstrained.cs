...
{
    class AxisNavigationConstrained : DependencyObject, IPlotterElement
    {
        #region Placement Property
        public static readonly DependencyProperty PlacementProperty = DependencyProperty.Register(
          "Placement",
          typeof(AxisPlacement),
          typeof(AxisNavigationConstrained),
          new FrameworkPropertyMetadata(AxisPlacement.Left, OnPlacementChanged));

        private static void OnPlacementChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            AxisNavigationConstrained navigation = (AxisNavigationConstrained)d;
